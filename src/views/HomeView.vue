    ...
    <div class="w-full h-[700px] p-9">
      <div class="flex flex-col gap-y-6">
        ...
        <div class="flex justify-between">
          <div class="flex flex-col text-center text-[25px] hover:cursor-pointer">
            <img src="../assets/images/iphone.png" alt="">
            <span style="font-family: 'Roboto', sans-serif;">Phone</span>
          </div>
          <div class="flex flex-col text-center text-[25px] hover:cursor-pointer">
            <img src="../assets/images/speaker.png" alt="">
            <span style="font-family: 'Roboto', sans-serif;">Mini Speaker</span>
          </div>
          <div class="flex flex-col text-center text-[25px] hover:cursor-pointer">
            <img src="../assets/images/tablet.png" alt="">
            <span style="font-family: 'Roboto', sans-serif;">Tablet</span>
          </div>
          <div class="flex flex-col text-center text-[25px] hover:cursor-pointer">
            <img src="../assets/images/big-headphone.png" alt="">
            <span style="font-family: 'Roboto', sans-serif;">Headphones</span>
          </div>
          <div class="flex flex-col text-center text-[25px] hover:cursor-pointer">
            <img src="../assets/images/laptop.png" alt="">
            <span style="font-family: 'Roboto', sans-serif;">Laptop</span>
          </div>
          <div class="flex flex-col text-center text-[25px] hover:cursor-pointer">
            <img src="../assets/images/accessories.png" alt="">
            <span style="font-family: 'Roboto', sans-serif;">Accessories</span>
          </div>
        </div>
        <div class="flex justify-between">
